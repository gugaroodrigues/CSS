...
public class AlimentoCadastro extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        out.println("<input type='text' class='form-control' id='campo-quantidade' name='quantidade'>");
        out.println("</div>");
        out.println("<div class=' form-group'>");
        ...
        out.println("<textarea class='form-control' id='campo-descricao' name='descricao'>");
